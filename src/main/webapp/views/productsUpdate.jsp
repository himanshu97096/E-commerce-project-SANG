			...
			<div class="row">
				<div class="col-sm-5">
					...
					<div class="form-group">
						<label for="name">Id</label> <input type="number"
							readonly="readonly" class="form-control border border-success"
					...
					<div class="form-group">
						<label for="name">Name</label> <input type="text"
							class="form-control border border-success" required name="name"
					...
					<div class="form-group">
						...
						<label for="category">Select Category</label> <select
							class="form-control border border-success" name="categoryid">
				...
				<div class="col-sm-5">
					<div class="form-group">
						...
						<textarea class="form-control border border-success" rows="4"
							name="description" placeholder="Product Details"
							value="${ pdescription }"></textarea>
					</div>
					<p>Product Image</p>
					<div class="custom-file">
						<input type="file" class="custom-file-input" name="productImage"
							value="${ product.image }" accept="image/jpeg, image/png"
							id="productImage" onchange="loadFile(event)" /> <label
							class="custom-file-label border border-success"
